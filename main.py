...
def path1_manual(scaler: Tesseract, dotproduct: Tesseract, vec_a: Array, vec_b: Array) -> dict[str, Array]:
...
def path2_jax(scaler: Tesseract, dotproduct: Tesseract, vec_a: Array, vec_b: Array) -> dict[str, Array]:
